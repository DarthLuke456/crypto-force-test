-- =====================================================
-- LIMPIEZA FORZADA: ELIMINAR TODAS LAS FUNCIONES Y RECREARLAS
-- =====================================================
-- Este script fuerza la eliminación de TODAS las funciones del schema public
...
DECLARE
    ...
    func_signature TEXT;
BEGIN
    -- Obtener todas las funciones del schema public con sus parámetros
    FOR func_record IN 
        SELECT 
            routine_name,
            routine_type,
