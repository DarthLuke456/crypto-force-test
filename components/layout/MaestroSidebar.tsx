...
const menuItems: MenuItem[] = [
  ...
  {
    label: 'Feedback',
    href: '/dashboard/maestro/feedback',
    icon: MessageSquare
  },
  {
    label: 'Ajustes',
      ...
      <nav className="flex-1 py-4 px-3">
            ...
            return (
              <li key={item.label}>
                ...
                >
                  ...
                  {isExpanded && (
                    <span 
                      className={`font-medium truncate sidebar-text ${
                        isActive 
                          ? 'text-white' 
        ...
        <div className="space-y-1">
          ...
          >
            ...
            {isExpanded && (
              <span 
                className={`font-medium text-gray-300 group-hover:text-[#8A8A8A] sidebar-text truncate ${isExpanded ? 'visible' : ''} delayed-profile`}
              >
                Perfil
              </span>
            )}
          ...
          >
            ...
            {isExpanded && (
              <span 
                className={`font-medium text-gray-300 group-hover:text-[#8A8A8A] sidebar-text truncate ${isExpanded ? 'visible' : ''} delayed-logout`}
              >
                Salir
              </span>
            )}
