...
export default function SidebarWarrior({ isCollapsed = false }: SidebarWarriorProps) {
  ...
  const navigationItems = [
    ...
    { name: 'Gráfico', href: '/dashboard/warrior/trading', icon: PieChart },
                ...
                <li key={item.name}>
                  {isCompassItem ? (
                    ...
                    <button
                      ...
                      className="flex items-center w-full px-4 py-3 text-sm font-medium text-gray-300 hover:bg-green-500/10 hover:text-green-500 hover:border-l-2 hover:border-l-green-500/50 rounded-md transition-colors"
      ...
      <div className="mt-auto p-4 border-t border-gray-700">
        {!isCollapsed && userData && (
          <div className="text-center">
            <div className="w-8 h-8 rounded-full mx-auto mb-2 flex items-center justify-center overflow-hidden border-2 border-green-500">
              {userAvatar ? (
                <img
                  src={userAvatar}
                  alt="Avatar"
