...
export default function SidebarLord({ isCollapsed = false }: SidebarLordProps) {
  ...
  const navigationItems = [
    { name: 'Inicio', href: '/dashboard/lord', icon: Home },
    { name: 'Análisis', href: '/dashboard/lord/analytics', icon: BarChart3 },
    { name: 'Estudiantes', href: '/dashboard/lord/students', icon: Users },
    { name: 'Cursos', href: '/dashboard/lord/courses', icon: BookOpen },
    { name: 'Gráfico', href: '/dashboard/lord/trading', icon: PieChart },
              ...
              <li key={item.name}>
                {isCompassItem ? (
                  ...
                  <button
                    ...
                    className="flex items-center w-full px-4 py-3 text-sm font-medium text-gray-300 hover:bg-blue-500/10 hover:text-blue-500 hover:border-l-2 hover:border-l-blue-500/50 rounded-md transition-colors"
      ...
      <div className="mt-auto p-4 border-t border-gray-700">
        {!isCollapsed && userData && (
          <div className="text-center">
            <div className="w-8 h-8 rounded-full mx-auto mb-2 flex items-center justify-center overflow-hidden border-2 border-blue-500">
              {userAvatar ? (
                <img
                  src={userAvatar}
                  alt="Avatar"
