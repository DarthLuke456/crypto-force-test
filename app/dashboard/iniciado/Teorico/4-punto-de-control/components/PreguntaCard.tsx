...
interface Props {
  ...
  respuestaCorrectaEstado: boolean;
  onSeleccion: (respuesta: number) => void;
  modulo: number;
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row items-end sm:items-center justify-end gap-2 mb-6">
        <div className="text-sm text-gray-600 dark:text-gray-400 text-right">
          Módulo {modulo} - Pregunta {preguntaActual + 1}/{totalPreguntas}
        </div>
      ...
      <p className="font-medium text-lg">{pregunta}</p>
        ...
        {opciones.map((opcion, index) => {
          ...
          return (
            <button
              ...
              className={`w-full p-3 rounded-md shadow transition-all duration-300 ${bgColor} ${textColor} border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-[#2a2a2a]`}
