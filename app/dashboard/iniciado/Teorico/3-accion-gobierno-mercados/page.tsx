...
export default function Modulo3Index() {
  return (
    <div className="min-h-screen bg-[#121212] text-white px-2 sm:px-8 py-8 max-w-3xl mx-auto">
      <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6 pt-12 relative">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">En este módulo analizaremos cómo los gobiernos intervienen en los mercados a través de políticas de control de precios y cómo estas intervenciones afectan el funcionamiento de los mercados y la economía en general.</p>
          
          <div className="bg-[#1a1a1a] rounded-lg p-6 mb-6">
            <h4 className="text-md font-semibold mb-3 text-[#ec4d58]">Temas principales:</h4>
            <ul className="list-disc list-inside space-y-2 text-sm">
              <li>Control de precios: máximos y mínimos</li>
              <li>Efectos del control del alquiler</li>
              <li>El salario mínimo y sus consecuencias</li>
              <li>Intervención gubernamental en criptomonedas</li>
              <li>Regulaciones en diferentes países</li>
              <li>El caso de Argentina y el BCRA</li>
            </ul>
          </div>
          ...
          <div className="bg-[#1a1a1a] rounded-lg p-6 mb-6">
            ...
            <ul className="list-disc list-inside space-y-2 text-sm">
              <li>Comprender los efectos de los controles de precios</li>
              <li>Analizar las consecuencias de las intervenciones gubernamentales</li>
              <li>Evaluar el impacto del salario mínimo en el empleo</li>
              <li>Conocer las regulaciones sobre criptomonedas</li>
              <li>Entender las políticas del BCRA en Argentina</li>
            </ul>
          </div>
