    ...
    <div className="min-h-screen bg-[#121212] text-white px-2 sm:px-8 py-8 max-w-3xl mx-auto">
      <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6 pt-12 relative">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">En este módulo exploraremos las fuerzas fundamentales que rigen los mercados: la oferta y la demanda. Aprenderemos cómo estas fuerzas interactúan para determinar precios y cantidades en los mercados competitivos.</p>
          
          <div className="bg-[#1a1a1a] rounded-lg p-6 mb-6">
            <h4 className="text-md font-semibold mb-3 text-[#ec4d58]">Temas principales:</h4>
            <ul className="list-disc list-inside space-y-2 text-sm">
              <li>Definición de mercado y competencia</li>
              <li>La ley de la demanda y sus variables</li>
              <li>Clasificación de bienes (normales, inferiores, sustitutos, complementarios)</li>
              <li>La ley de la oferta y sus determinantes</li>
              <li>Equilibrio de mercado</li>
              <li>El mercado de las criptomonedas</li>
                  </ul>
          </div>
          ...
          <div className="bg-[#1a1a1a] rounded-lg p-6 mb-6">
            ...
            <ul className="list-disc list-inside space-y-2 text-sm">
              <li>Entender cómo funcionan los mercados competitivos</li>
              <li>Analizar las fuerzas de oferta y demanda</li>
              <li>Comprender el concepto de equilibrio de mercado</li>
              <li>Identificar los factores que desplazan las curvas</li>
          ...
          <div className="text-center">
            <Link 
              href="/dashboard/iniciado/Teorico/2-fuerzas-del-mercado/contenido"
