...
export default function ModuloPractico5Index() {
  return (
    <div className="min-h-screen bg-[#121212] text-white px-2 sm:px-8 py-8 max-w-3xl mx-auto">
      <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6 pt-12 relative">
        ...
        <section className="mb-8">
          ...
          <p className="mb-6">En este módulo aprenderás a utilizar los indicadores RSI y MACD para identificar tendencias, niveles de sobrecompra/sobreventa y señales de entrada y salida en los mercados financieros.</p>
          ...
          <div className="bg-[#1a1a1a] rounded-lg p-6 mb-6">
            ...
            <ul className="list-disc list-inside space-y-2 text-sm">
              ...
              <li>RSI: Operaciones Históricas</li>
              <li>Trabajo Práctico – Colocación de una Operación</li>
              <li>La pregunta del Día</li>
              <li>Prueba RSI</li>
              <li>Operar con MACD</li>
              <li>MACD: Operaciones Históricas</li>
              <li>Trabajo Práctico- Colocación de una Operación</li>
              <li>La pregunta del día</li>
              <li>Prueba MACD</li>
            </ul>
          ...
          <div className="bg-[#1a1a1a] rounded-lg p-6 mb-6">
            ...
            <ul className="list-disc list-inside space-y-2 text-sm">
              <li>Comprender el funcionamiento del RSI y el MACD</li>
          ...
          <div className="text-center">
            <Link 
              href="/dashboard/iniciado/Practico/5-indicadores-rsi-macd/contenido"
