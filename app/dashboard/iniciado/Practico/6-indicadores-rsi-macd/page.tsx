        ...
        <section className="mb-8">
          ...
          <div className="bg-[#1a1a1a] rounded-lg p-6 mb-6">
            ...
            <ul className="list-disc list-inside space-y-2 text-sm">
              <li>¿Qué es el RSI?</li>
              <li>¿Cómo operar con RSI?</li>
              <li>¿Qué es el MACD?</li>
              <li>¿Cómo operar con MACD?</li>
              <li>Ejemplos prácticos y señales</li>
          ...
          <div className="text-center">
            <Link 
              href="/dashboard/iniciado/Practico/6-indicadores-rsi-macd/contenido"
