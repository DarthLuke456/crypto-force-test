...
export default function DynamicCarousel({ modules, title, className = '' }: DynamicCarouselProps) {
  ...
  useEffect(() => {
    ...
    const handleWheel = (e: WheelEvent) => {
      console.log('🎯 Scroll NATIVO en carrousel DINÁMICO detectado!', e.deltaY);
      e.preventDefault();
      e.stopPropagation();
      ...
      console.log('🎯 Dinámico scroll NATIVO: ', currentScroll, '->', newScroll, 'max:', maxScroll);
    };
