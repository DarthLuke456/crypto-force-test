-- =====================================================
-- EXACT SIGNATURE: ELIMINAR FUNCIONES POR FIRMA ESPECÍFICA
-- =====================================================
-- Este script elimina las funciones específicas con sus parámetros exactos

-- =====================================================
-- 1. ELIMINAR FUNCIONES POR FIRMA ESPECÍFICA
-- =====================================================
...
SELECT NOW() as current_time, 'Functions eliminated by exact signature' as status;
