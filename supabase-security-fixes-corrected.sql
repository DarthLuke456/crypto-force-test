-- =====================================================
-- CORRECCIONES DE SEGURIDAD PARA SUPABASE - VERSIÓN CORREGIDA
-- =====================================================
...
-- WHERE table_name = 'referral_history' AND table_schema = 'public';
...
-- Nota: Ajustar según la estructura real de la tabla
...
CREATE OR REPLACE FUNCTION public.process_new_referral(referrer_id UUID, referred_id UUID)
RETURNS VOID
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public, auth
...
BEGIN
    ...
    INSERT INTO public.referral_history (referrer_id, referred_id, created_at)
